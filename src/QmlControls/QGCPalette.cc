...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(text,                 "#9d9d9d", "#333333", "#9d9d9d", "#E9E9E9")
    DECLARE_QGC_COLOR(warningText,          "#cc0808", "#cc0808", "#f85761", "#f85761")
    DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#3d3d3d", "#3a3a4a")
    DECLARE_QGC_COLOR(buttonBorder,         "#9d9d9d", "#73BAF2", "#5a5a5a", "#73BAF2")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#333333", "#9d9d9d", "#E9E9E9")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#73BAF2", "#3a3a3a", "#73BAF2")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#ffffff")
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#73BAF2", "#585858", "#73BAF2")
    DECLARE_QGC_COLOR(primaryButtonText,    "#2c2c2c", "#1a1a1a", "#2c2c2c", "#1a1a1a")
    DECLARE_QGC_COLOR(textField,            "#ffffff", "#ffffff", "#363636", "#E9E9E9")
    ...
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#73BAF2", "#585858", "#73BAF2")
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#5a8cb8", "#585858", "#5a8cb8")
    ...
    DECLARE_QGC_COLOR(colorBlue,            "#1a72ff", "#1a72ff", "#73BAF2", "#73BAF2")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#dbfef8", "#585858", "#3a3a5a")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#585858", "#4a5a7a")
