                ...
                Row {
                    ...
                    QGCButton {
                        ...
                        MessageDialog {
                            ...
                            text:       qsTr("This will restart the WiFi Bridge so the settings you've changed can take effect. Note that you may have to change your computer WiFi settings and Visvakarn GCS link settings to match these changes. Are you sure you want to restart it?")
